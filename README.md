...
|------|------|
| 에러 추적 | Sentry |
| 메트릭 | Prometheus (prom-client) |


---

## 📚 FE WIKI
> 프론트엔드 설계 단계에서 정리한 문서는 아래 위키에서 확인할 수 있습니다.

- 기획: Figma, 요구사항 정의서
- 설계: 기술 스택 선정, 유저 플로우 차트, 도메인 테크 스펙
- 구조: 프론트엔드 개발 표준 및 구조 설계, 폴더 구조 설명

- [Frontend Wiki 바로가기](https://github.com/100-hours-a-week/9-team-Devths-WIKI/wiki/Frontend-Wiki)
